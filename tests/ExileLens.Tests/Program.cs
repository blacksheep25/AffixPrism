...
string cacheDir = Path.Combine(Path.GetTempPath(), "ExileLens-test-" + Guid.NewGuid());
try
{
...
string repositoryPath = Path.Combine(Path.GetTempPath(), "ExileLens-repository-" + Guid.NewGuid());
try
{
...
var bookmarkPath = Path.Combine(Path.GetTempPath(), "ExileLens-bookmarks-" + Guid.NewGuid(), "items.json");
try {
...
var notePath=Path.Combine(Path.GetTempPath(),"ExileLens-note-"+Guid.NewGuid(),"notes.json");
