...
public partial class MainWindow
{
    ...
    private readonly MarketRepository localMarket = new(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AffixPrism", "market-service"));
    ...
    private readonly EconomyClient economy = new(new HttpClient { Timeout = TimeSpan.FromSeconds(12), MaxResponseContentBufferSize = 16 * 1024 * 1024 }, Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AffixPrism", "economy"));
