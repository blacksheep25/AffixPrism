...
public partial class MainWindow
{
    ...
    private string SessionPath => smoke ? Path.GetFullPath("artifacts/smoke-session.json") : Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AffixPrism", "session.json");
