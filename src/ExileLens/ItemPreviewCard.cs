...
public sealed class ItemPreviewCard : Border
{
    ...
    private void Render()
    {
        ...
        Background = Color(16,16,14); BorderThickness = new Thickness(1); Padding = new Thickness(10);
        ...
        stack.Children.Add(new Border { Background = Color(33,29,17), BorderBrush = rarity, BorderThickness = new Thickness(0,1,0,1), Padding = new Thickness(4), Child = header });
        stack.Children.Add(new RemoteItemIcon { Url = IconUrl, Height = 90, MaxWidth = 100, Stretch = Stretch.Uniform, HorizontalAlignment = HorizontalAlignment.Center, Margin = new Thickness(0,10,0,6) });
