...
public partial class MainWindow
{
    ...
    private string CharacterFile=>Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"ExileLens","character.json");
    ...
    private void EditCharacter(object sender,RoutedEventArgs e)
    {
        ...
        var dialog=new Window { Owner=this,Title="Your character",Width=440,Height=500,ResizeMode=ResizeMode.CanResize,MinWidth=360,MinHeight=360,WindowStartupLocation=WindowStartupLocation.CenterOwner,Background=new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(24,23,18)),Foreground=Foreground,Resources=Resources,Content=new ScrollViewer { Content=panel,VerticalScrollBarVisibility=ScrollBarVisibility.Auto } };
