...
- **See the trade-offs:** an **At a glance** table compares damage, speed, critical chance, skill levels or defences. Choose **Physical attacks**, **Elemental attacks**, **Spells** or **Defences**. Higher values appear green, lower values red, and equal or unavailable values grey. Gains, losses and a cautious verdict help you assess the displayed stats; they do not simulate your full build.
