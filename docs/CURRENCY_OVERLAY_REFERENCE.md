...
- Bind any account sign-in to ExileLens's own local browser session; never read another overlay's cookies.
...
Status: review only. Live rare-item collection remains unconnected in ExileLens. This reference identifies a practical website-search adapter and stat-mapping approach, not a completed live integration.
