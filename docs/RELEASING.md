...
5. Commit/push; require a successful Windows CI build for that commit. Tag that exact commit and create a GitHub release with the changelog, ZIP and checksum. Mark experimental versions as prereleases.
